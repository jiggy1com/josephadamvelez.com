    ...
    var DEFAULTS = {
        data: [
            ...
            },
            {
                ...
                description:
                    '4 page brochure site for golf wear. E-commerce provided by SquareUp.com.',
                technology: [
                    'PHP',
                    'HTML',
                    'CSS',
        ...
        loadModal: function (e) {
            ...
            modalInterior = modalInterior.replace(
                /{{description}}/g,
                DEFAULTS.data[portfolioID].description,
            );
            modalInterior = modalInterior.replace(
                /{{website}}/g,
                DEFAULTS.data[portfolioID].folder,
            );
            ...
            for (var i = 1; i <= DEFAULTS.data[portfolioID].images; i++) {
                ...
                additionalScreenShotsTemplate = additionalScreenShotsTemplate.replace(
                    /{{folder}}/g,
                    DEFAULTS.data[portfolioID].folder,
                );
