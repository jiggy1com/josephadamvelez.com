...
(function (e) {
    ...
    e.flexslider = function (t, n) {
                ...
                setupPaging: function () {
                    ...
                    if (r.pagingCount > 1) {
                        for (var a = 0; a < r.pagingCount; a++) {
                            s =
                                r.vars.controlNav === 'thumbnails'
                                    ? '<img src="' + r.slides.eq(a).attr('data-thumb') + '"/>'
                                    : '<a>' + n + '</a>';
            ...
            touch: function () {
                ...
                function v(f) {
                    ...
                    if (r.animatingTo === r.currentSlide && !a && !(o === null)) {
                        ...
                        if (
                            r.canAdvance(p) &&
                            ((Number(new Date()) - u < 550 && Math.abs(c) > 50) ||
                                Math.abs(c) > s / 2)
                        ) {
        ...
        r.canAdvance = function (e, t) {
            ...
            return t
                ? true
                : p && r.currentItem === r.count - 1 && e === 0 && r.direction === 'prev'
                  ? true
                  : p && r.currentItem === 0 && e === r.pagingCount - 1 && r.direction !== 'next'
                    ? false
                    : e === r.currentSlide && !p
                      ? false
                      : r.vars.animationLoop
        ...
        r.setup = function (t) {
            if (!h) {
                ...
                if (r.vars.animationLoop && !c) {
                    ...
                    r.container
                        .append(
                            r.slides.first().clone().addClass('clone').attr('aria-hidden', 'true'),
                        )
                        .prepend(
                            r.slides.last().clone().addClass('clone').attr('aria-hidden', 'true'),
                        );
                }
